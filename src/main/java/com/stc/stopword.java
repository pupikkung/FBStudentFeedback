...
public class stopword {
    ...
    static {
        ...
        if (m_Stopwords == null) {
            ...
            m_Stopwords.put("back", dummy);//stopword internet
            ...
            m_Stopwords.put("click", dummy);//stopword internet
            ...
            m_Stopwords.put("copyright", dummy);//stopword internet
            ...
            m_Stopwords.put("enter", dummy);//stopword internet
            ...
            m_Stopwords.put("home", dummy);//stopword internet
            m_Stopwords.put("homepage", dummy);//stopword internet
            m_Stopwords.put("hopefully", dummy);
            m_Stopwords.put("how", dummy);
            m_Stopwords.put("howbeit", dummy);
            m_Stopwords.put("however", dummy);
            m_Stopwords.put("html", dummy);//stopword internet
            ...
            m_Stopwords.put("internet", dummy);//stopword internet
            ...
            m_Stopwords.put("link", dummy);//stopword internet
            m_Stopwords.put("links", dummy);//stopword internet
            m_Stopwords.put("little", dummy);
            m_Stopwords.put("ll", dummy); //added to avoid words like you'll,I'll etc.
            m_Stopwords.put("login", dummy);//stopword internet
            m_Stopwords.put("logout", dummy);//stopword internet
            ...
            m_Stopwords.put("main", dummy);//stopword internet
            ...
            m_Stopwords.put("meta", dummy);//stopword internet
            ...
            m_Stopwords.put("navigation", dummy);//stopword internet  
            ...
            m_Stopwords.put("next", dummy);//and internet
            ...
            m_Stopwords.put("online", dummy);//stopword internet
            ...
            m_Stopwords.put("page", dummy);//stopword internet
            ...
            m_Stopwords.put("point", dummy);//stopword internet
            m_Stopwords.put("possible", dummy);
            m_Stopwords.put("presumably", dummy);
            m_Stopwords.put("previous", dummy);//stopword internet
            ...
            m_Stopwords.put("site", dummy);//stopword internet
            m_Stopwords.put("sites", dummy);//stopword internet 
            ...
            m_Stopwords.put("top", dummy);//stopword internet
            ...
            m_Stopwords.put("url", dummy);//stopword internet
            ...
            m_Stopwords.put("web", dummy);//stopword internet
            m_Stopwords.put("website", dummy);//stopword internet
            ...
            m_Stopwords.put("would", dummy);
            m_Stopwords.put("www", dummy);//stopword internet
    ...
    public static boolean isStopword(String str) {
        return m_Stopwords.containsKey(str);
    }
}
